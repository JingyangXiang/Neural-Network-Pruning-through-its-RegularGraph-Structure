...
python main.py --config configs/experiments/$3-graph-$1.yaml --multigpu $2 --name 64_20 --first-layer-dense --last-layer-dense --set-connection --freeze-subnet --matrix Adjacency/64/20/M1$29.npy
done
