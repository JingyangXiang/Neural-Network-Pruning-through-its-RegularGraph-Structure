...
def parse_arguments():
    ...
    parser.add_argument(
        "--linear-type", type=str, default='DenseLinear', help="What kind of sparsity to use"
    )
    parser.add_argument(
        "--freeze-weights",
        action="store_true",
    ...
    parser.add_argument(
        "--extreme",
        action="store_true",
        help="search extreme when True",
    )
    parser.add_argument(
        "--set-connection",
        action="store_true",
        help="Set connection to graph conv2d",
    )
    parser.add_argument(
        "--matrix",
        default=None,
